...
- inputs: the DeviceProtection:1 service specification PDF, internalized
  ...
  at component docs/upnp-wip2/ (the source PDF and the conversion, the
  contract transcribed in TRANSCRIPTION.md), the canonical mapping engine
...
its conversion committed beside it as docs/upnp-wip2/. The published
